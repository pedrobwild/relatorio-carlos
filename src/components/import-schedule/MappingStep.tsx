...
import { type ColumnMapping, REQUIRED_FIELDS, OPTIONAL_FIELDS, FIELD_LABELS } from './types';
...
export const MappingStep = ({ headers, columnMapping, onMappingChange, onBack, onContinue }: MappingStepProps) => (
  <div className="space-y-6">
    ...
    <div className="grid gap-4">
      {[...REQUIRED_FIELDS, ...OPTIONAL_FIELDS].map(field => (
        <div key={field} className="grid grid-cols-2 gap-4 items-center">
          ...
          <Select value={columnMapping[field]} onValueChange={(value) => onMappingChange(field, value)}>
    ...
    <div className="flex justify-between pt-4 border-t">
      ...
      <Button onClick={onContinue} className="min-h-[44px]">Continuar</Button>
    </div>
  </div>
);
