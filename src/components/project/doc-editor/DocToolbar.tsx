...
import {
  ...
  Undo, Redo, Link, Quote, Code, Minus, Save, CheckCircle2, Loader2,
} from 'lucide-react';
...
export function DocToolbar({ exec, execBlock, onInsertLink, saving, saved, onManualSave }: DocToolbarProps) {
  return (
    <div className="sticky top-0 z-10 bg-background border border-border rounded-t-lg">
      <div className="flex items-center gap-0.5 px-3 py-2 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" variant="outline" onClick={onManualSave} disabled={saving}>
