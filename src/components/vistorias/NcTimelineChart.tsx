  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">NCs abertas vs. fechadas (últimos 6 meses)</CardTitle>
      </CardHeader>
      <CardContent className="h-52 sm:h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} barGap={2}>
            ...
            <Bar dataKey="abertas" fill="hsl(var(--destructive))" radius={[4, 4, 0, 0]} maxBarSize={32} />
            <Bar dataKey="fechadas" fill="hsl(var(--primary))" radius={[4, 4, 0, 0]} maxBarSize={32} />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
