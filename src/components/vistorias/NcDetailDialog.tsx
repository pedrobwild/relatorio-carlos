...
export function NcDetailDialog({ nc, open, onOpenChange }: Props) {
  ...
  const [editDeadline, setEditDeadline] = useState<Date | undefined>(
    nc.deadline ? parseISO(nc.deadline) : undefined,
  );
  ...
  const [photosBefore, setPhotosBefore] = useState<string[]>(
    nc.evidence_photos_before ?? nc.evidence_photo_paths ?? [],
  );
  const [photosAfter, setPhotosAfter] = useState<string[]>(
    nc.evidence_photos_after ?? [],
  );
  ...
  const handleTransition = async (newStatus: NcStatus) => {
    try {
      ...
      await updateStatus.mutateAsync({
        ...
        corrective_action:
          newStatus === "in_treatment" ? correctiveAction : undefined,
        resolution_notes:
          newStatus === "pending_verification" ? actionNotes : undefined,
        evidence_photos_before:
          photosBefore.length > 0 ? photosBefore : undefined,
      ...
      <DialogContent className="max-w-2xl max-h-[100dvh] sm:max-h-[85dvh] overflow-y-auto p-4 sm:p-6">
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Esta ação não pode ser desfeita. A NC"{nc.title}" e todo o
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                      ...
                      onClick={() => {
                        deleteNc.mutate(
                          { id: nc.id, project_id: nc.project_id },
                          {
          ...
          <div className="space-y-3 border rounded-lg p-3 bg-muted/30">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  value={editSeverity}
                  onValueChange={(v) => setEditSeverity(v as NcSeverity)}
                >
                  <SelectTrigger className="h-10">
                    <SelectValue />
                  </SelectTrigger>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {editDeadline
                        ? format(editDeadline, "dd/MM/yyyy", { locale: ptBR })
                        : "Sem prazo"}
                    </Button>
                  </PopoverTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={setEditResponsibleUserId}
              >
                <SelectTrigger className="h-10">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button
                ...
                disabled={!editTitle.trim() || updateNc.isPending}
                className="h-9"
              >
        ...
        {!editing && (
          <>
            <div className="flex flex-wrap gap-2">
              <span
                className={`text-xs font-semibold px-2 py-1 rounded ${sev.className}`}
              >
                {sev.label}
              </span>
              {ncCategory && (
              ...
              <Badge
                variant={nc.status === "closed" ? "secondary" : "destructive"}
              >
              ...
              {nc.deadline && (
                <span className="text-xs text-muted-foreground flex items-center gap-1">
                  ...
                  Prazo:{" "}
                  {format(parseISO(nc.deadline), "dd/MM/yyyy", {
                    locale: ptBR,
                  })}
                </span>
              )}
                ...
                {ncActualCost != null && (
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "text-xs font-medium",
                        costOverrun && "text-destructive",
                      )}
                    >
                      {formatBRL(ncActualCost)}
                    </span>
                  </div>
                )}
              </div>
        ...
        {nc.rejection_reason && (
          <div className="space-y-1">
            ...
            <p className="text-sm bg-destructive/5 rounded-lg p-3 border border-destructive/20 break-words">
              {nc.rejection_reason}
            </p>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <EvidenceUpload
                ...
                disabled={
                  !["open", "reopened", "in_treatment"].includes(nc.status)
                }
              />
            </div>
            ...
            {[
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-muted-foreground">
                  Adicione fotos mostrando como o problema foi corrigido
                </p>
                <EvidenceUpload
                  projectId={nc.project_id}
                  entityId={`${nc.id}-after`}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-40 overflow-y-auto">
                {history.map((entry) => (
                  <div
                    key={entry.id}
                    className="flex flex-col sm:flex-row sm:items-start gap-0.5 sm:gap-2 text-xs"
                  >
