...
export const INSPECTION_TYPES: {
  ...
  {
    value: "recebimento_etapa",
    label: "Recebimento de Etapa",
    emoji: "✅",
    color: "bg-green-100 text-green-700",
  },
  {
    value: "entrega_cliente",
  ...
  {
    value: "pos_chuva",
    label: "Pós-Chuva / Emergência",
    emoji: "🌧️",
    color: "bg-cyan-100 text-cyan-700",
  },
  {
    value: "garantia",
    label: "Garantia (Pós-Entrega)",
    emoji: "🛡️",
...
export const TYPE_TO_TEMPLATE_CATEGORY: Partial<
