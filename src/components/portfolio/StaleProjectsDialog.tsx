...
export function StaleProjectsDialog({
 open, onOpenChange, projects, summaries,
 ...
 <div>
 <DialogTitle className="text-base">Obras sem atualização</DialogTitle>
 <DialogDescription className="text-xs">
 {staleProjects.length} obra(s) sem atividade registrada há mais de 7 dias
 </DialogDescription>
 </div>
 </div>
 </DialogHeader>
 ...
 <p className="text-sm text-muted-foreground">Todas as obras estão atualizadas ✓</p>
 </div>
 ) : (
