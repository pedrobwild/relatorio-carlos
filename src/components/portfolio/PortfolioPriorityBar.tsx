...
const priorityButtons = [
  ...
  { key: 'no-update', label: 'Sem update 7d+', icon: Ghost, color: 'text-amber-600 border-amber-300 bg-amber-50 dark:text-amber-400 dark:border-amber-500/30 dark:bg-amber-500/10' },
  { key: 'cost-risk', label: 'Custo em risco', icon: DollarSign, color: 'text-destructive border-destructive/30 bg-destructive/5' },
  { key: 'delivery-14d', label: 'Entrega 14d', icon: CalendarClock, color: 'text-blue-600 border-blue-300 bg-blue-50 dark:text-blue-400 dark:border-blue-500/30 dark:bg-blue-500/10' },
] as const;
