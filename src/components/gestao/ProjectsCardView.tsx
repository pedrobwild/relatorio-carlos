...
function ProjectCard({
  ...
  const hasAlerts =
    overdueCount > 0 || unsignedFormalizations > 0 || pendingDocuments > 0;
            ...
            {overdueCount > 0 && (
              <Tooltip>
                ...
                <TooltipContent side="top" className="text-xs">
                  {overdueCount} atividade(s) em atraso
                </TooltipContent>
              </Tooltip>
            )}
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <StatusBadge
                    ...
                    showDot={false}
                  >
                    {unsignedFormalizations} assinatura
                    {unsignedFormalizations > 1 ? "s" : ""}
                  </StatusBadge>
                </TooltipTrigger>
                <TooltipContent side="top" className="text-xs">
                  {unsignedFormalizations} formalização(ões) aguardando
                  assinatura
                </TooltipContent>
              </Tooltip>
            )}
