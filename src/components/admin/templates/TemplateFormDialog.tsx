...
import { CATEGORIES, totalDays, totalWeight, type FormState, type ActivityItem } from './types';
...
interface TemplateFormDialogProps {
  ...
  onUpdateActivity: (idx: number, field: keyof ActivityItem, value: string | number) => void;
  onAddActivity: () => void;
...
export function TemplateFormDialog({
  ...
  onSave, isSaving, onPresetChange,
  onUpdateActivity, onAddActivity, onRemoveActivity,
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Select value={form.selected_activity_template} onValueChange={onPresetChange}>
                    ...
                    <TableBody>
                      {form.custom_activities.map((act, i) => (
                        ...
                        >
                          ...
                          <TableCell className="p-1">
                            <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive" onClick={() => onRemoveActivity(i)}>
                ...
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {form.custom_activities.length > 0 && totalWeight(form.custom_activities) !== 100 && (
                      <span className="text-xs text-amber-600">⚠ Peso total ≠ 100%</span>
                    )}
                  </div>
                </div>
              </div>
