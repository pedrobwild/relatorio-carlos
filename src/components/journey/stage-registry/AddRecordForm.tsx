...
import { useCreateStageRecord, type RecordCategory } from '@/hooks/useStageRecords';
...
export function AddRecordForm({ stageId, projectId, category, onClose, minutesOnly, stageName }: AddRecordFormProps) {
  const { user } = useAuth();
