...
const vsConfig: Record<VisualState, {
  ...
  completed: {
    ...
    badgeClass: 'bg-[hsl(var(--success-light))] text-[hsl(var(--success))] border-0',
  ...
  validating: {
    ...
    badgeClass: 'bg-[hsl(var(--warning-light))] text-[hsl(var(--warning))] border-0',
...
export function JourneyTimelineSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="px-0 pt-2 pb-[env(safe-area-inset-bottom)] max-h-[85dvh] rounded-t-2xl">
        {/* Drag handle */}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="text-xs flex items-center gap-1.5">
                        <Badge className={cn('text-[10px] h-5 px-1.5', cfg.badgeClass)}>
                          {cfg.label}
                        </Badge>
                        {isCompleted && completionDate && (
                          <span className="text-muted-foreground text-[11px]">{completionDate}</span>
                        )}
                      </span>
                    </div>
