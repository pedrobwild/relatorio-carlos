...
export function WelcomeContractCard({ onAcknowledge }: WelcomeContractCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-sm text-foreground">Resumo do Contrato</h3>
            <p className="text-xs text-primary font-medium">Etapa de Projeto (3D + Executivo) — o que cada parte faz</p>
          </div>
      ...
      <AnimatePresence initial={false}>
        {expanded && (
          <motion.div key="contract-content" variants={contentVariants} initial="collapsed" animate="expanded" exit="exit">
            <CardContent className="space-y-5 pt-0 px-4 pb-5 md:px-6 md:pb-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Esta etapa transforma o que foi combinado em um plano técnico (Projeto 3D e Projeto Executivo) que guia decisões, compras e execução. Aqui fica definido o que pode mudar, o que precisa de aprovação e o que cada parte deve entregar para a obra seguir com segurança.
                </p>
              </div>

              {/* Bwild commitments */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-foreground">A Bwild (Contratada) se compromete a:</h4>
              ...
              {/* Client commitments */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-foreground">Você (Contratante) se compromete a:</h4>
                <ul className="space-y-2">
              ...
              {/* Important rules */}
              <div className="space-y-3">
                <h4 className="text-sm font-semibold text-foreground">Regras importantes (para evitar retrabalho)</h4>
                <ul className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground/70 italic">
                Este é um resumo para facilitar sua leitura. Em caso de dúvida, vale o texto do contrato.
              </p>
