...
export const statusConfig: Record<DateStatus, { label: string; badgeClass: string; icon: React.ElementType }> = {
  confirmed: {
...
export function DivergenceWarning({ proposed, confirmed }: { proposed: string; confirmed: string }) {
