 ...
 export function JourneyCSMSection({ csm, projectId, isAdmin, onUpdate }: JourneyCSMSectionProps) {
           ...
           <div className="flex-1 space-y-4">
             <div>
               <div className="flex items-center gap-2 mb-1">
                 ...
                 <h3 className="text-xl font-semibold">{csm.name}</h3>
               </div>
               <p className="text-sm text-primary font-medium">{csm.role_title}</p>
             </div>
             ...
             <div className="pt-2 space-y-2">
               <p className="text-sm font-medium text-foreground">Sempre que precisar, você pode contar com ela.</p>
