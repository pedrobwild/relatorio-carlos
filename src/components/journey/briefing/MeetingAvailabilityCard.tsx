...
import { CalendarIcon, Clock, Info, Send, Edit2, Loader2 } from 'lucide-react';
    ...
    <Card>
      <CardContent className="pt-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          {weekdayWarning && (
            <p className="text-xs text-amber-600 dark:text-amber-400">{weekdayWarning}</p>
          )}
        </div>
