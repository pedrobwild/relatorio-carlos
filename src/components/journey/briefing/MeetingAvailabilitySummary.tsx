...
export function MeetingAvailabilitySummary({ existing, isAdmin, onEdit }: MeetingAvailabilitySummaryProps) {
  return (
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <div className="flex items-start justify-between gap-3">
            ...
            {!isAdmin && (
              <Button size="sm" variant="outline" className="h-10 gap-1.5 text-xs min-h-[44px] shrink-0" onClick={onEdit}>
