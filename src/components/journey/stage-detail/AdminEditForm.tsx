...
import { JourneyStage, JourneyStageStatus, useUpdateStage } from '@/hooks/useProjectJourney';
...
export function AdminEditForm({ stage, projectId, onClose }: AdminEditFormProps) {
