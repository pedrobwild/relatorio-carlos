...
export function BudgetItemSwapForm({ onComplete, initialData }: BudgetItemSwapFormProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Torneira Deca Quadrada" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Nome do Item</FormLabel>
                  <FormControl>
                    <Input placeholder="Ex: Torneira Docol Quadrada" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
