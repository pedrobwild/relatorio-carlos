...
const ReportSection = ({ title, variant, children, className }: ReportSectionProps) => (
  <div
    className={cn(
      "p-6 rounded-lg mb-6 border-l-4",
  ...
  return (
    <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      <ReportSection variant="green" title="2) Estratégia adotada para recuperar prazo (sem comprometer qualidade)">
        <h4 className="text-base md:text-lg font-semibold text-foreground mt-4 mb-3">
        ...
        <ul className="list-disc ml-6 text-muted-foreground leading-relaxed space-y-2 mb-4">
        ...
        <h4 className="text-base md:text-lg font-semibold text-foreground mt-6 mb-3">
      ...
      <div className="bg-gradient-to-r from-accent to-primary/20 p-6 rounded-lg mt-8">
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <p className="font-semibold text-foreground">Pedro Henrique Alves Pereira</p>
        <p className="text-primary font-bold">CEO - Bwild</p>
      </div>
    </div>
  );
};
