    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4">
        ...
        >
          ...
          <span className="text-2xl font-bold text-[hsl(var(--warning))] tabular-nums">
            {pendingCount}
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-2xl font-bold text-[hsl(var(--success))] tabular-nums">
            {signedCount}
          </span>
        </button>
        <button
          ...
          description={
            activeTab === "pendentes"
              ...
              : canCreate
                ...
                : "Documentos formais como aditivos, orçamentos e atas serão criados pela equipe técnica conforme a obra avança."
          }
          hint={
            activeTab !== "pendentes" && !canCreate
              ? "Você receberá uma notificação quando houver um documento aguardando sua assinatura."
              : undefined
          }
            ...
            >
              <Card className="h-full group-hover:border-primary/50 group-hover:shadow-sm transition-all duration-200 overflow-hidden">
                <CardContent className="p-0">
                  <div
                    className={`h-1 ${formalizacao.status === "signed" ? "bg-[hsl(var(--success))]" : formalizacao.status === "pending_signatures" ? "bg-[hsl(var(--warning))]" : formalizacao.status === "voided" ? "bg-destructive" : "bg-muted"}`}
                  />
                  <div className="p-4">
                        ...
                        formalizacao.parties_total !== null && (
                          <>
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              {formalizacao.parties_signed}/
                              {formalizacao.parties_total}
                            </span>
                          </>
                        )}
                    </div>
