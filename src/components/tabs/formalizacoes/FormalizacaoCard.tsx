...
export function FormalizacaoCard({ formalizacao, basePath, index = 0, showStatusLabel = true }: FormalizacaoCardProps) {
  return (
    <Link
          ...
          <div className="p-4">
            <div className="flex items-center justify-between gap-2 mb-2">
              ...
              >
                ...
                {showStatusLabel && FORMALIZATION_STATUS_LABELS[formalizacao.status as FormalizationStatus]}
              </Badge>
            </div>
