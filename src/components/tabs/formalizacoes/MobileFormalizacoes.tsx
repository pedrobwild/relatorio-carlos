...
export function MobileFormalizacoes({
 ...
 <TabsTrigger value="pendentes" className="relative gap-1.5 data-[state=active]:bg-amber-100">
 ...
 <TabsTrigger value="finalizadas" className="gap-1.5 data-[state=active]:bg-green-100">
