import { Check, Clock, Calendar, Download, FileText, Loader2 } from "lucide-react";
        ...
        <div className="md:hidden">
          ...
          <div className="divide-y divide-border">
            {payments.map((payment) => {
              const daysLabel = getDaysLabel(payment);
              return (
                <div key={payment.id} className="px-4 py-4 hover:bg-muted/30 transition-colors">
          ...
          <div className="px-4 py-4 text-center">
            <p className="text-caption">Última atualização: {formatDate(today)}</p>
          </div>
        </div>
      </div>
    </TooltipProvider>
