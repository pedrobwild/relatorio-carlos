...
export function DataQualityWarnings({ warnings }: { warnings: DataQualityWarning[] }) {
  if (!warnings || warnings.length === 0) return null;
  return (
    <div className="rounded-md border border-amber-200/80 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-900/50 p-3 space-y-2">
