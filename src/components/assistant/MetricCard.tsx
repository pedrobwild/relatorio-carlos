...
export function MetricCard({ metric, className }: { metric: MetricSnapshot; className?: string }) {
 ...
 <p className="text-xl font-bold leading-tight truncate" title={String(metric.value)}>
 {metric.value}
 </p>
