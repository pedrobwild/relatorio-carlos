 import { CheckCircle2, Circle, Clock, FileCode, FileText, Building } from 'lucide-react';
 ...
 export function ProjectJourney({ currentStep = 'projeto_3d', className }: ProjectJourneyProps) {
     ...
     <div className={cn("w-full", className)}>
       <div className="relative">
         ...
         <div 
           ...
           style={{
             height: currentStep === 'completed' ? 'calc(100% - 120px)' 
               : currentStep === 'liberacao' ? 'calc(66% - 40px)'
               : currentStep === 'projeto_executivo' ? 'calc(33% - 20px)'
               : '0%'
           }}
         />
         <div 
           ...
           style={{
             width: currentStep === 'completed' ? 'calc(100% - 200px)' 
               : currentStep === 'liberacao' ? 'calc(66% - 100px)'
               : currentStep === 'projeto_executivo' ? 'calc(33% - 50px)'
               : '0%'
           }}
         />
