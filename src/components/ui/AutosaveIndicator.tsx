 ...
 */
export function AutosaveIndicator({ lastSavedAt, saving, className = '' }: AutosaveIndicatorProps) {
  ...
  const label =
    minutes < 1 ? 'Rascunho salvo agora' : minutes === 1 ? 'Rascunho salvo há 1 min' : `Rascunho salvo há ${minutes} min`;
