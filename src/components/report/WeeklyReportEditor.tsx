        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-base sm:text-lg font-bold truncate">Editar Relatório - Semana {formData.weekNumber}</h2>
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-white/80">
                <span className="truncate">Período: {formData.periodStart} a {formData.periodEnd}</span>
          ...
          <div className="flex gap-2 shrink-0">
            ...
            <Button onClick={handleSave} disabled={isSaving} className="bg-white text-primary hover:bg-white/90 min-h-[44px]">
