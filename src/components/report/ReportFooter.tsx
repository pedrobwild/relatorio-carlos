    ...
    <div className="bg-card rounded-lg border border-border p-4 sm:p-5 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4 pt-3 border-t border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-foreground">(11) 99999-9999</span>
        </div>
        <div className="flex items-center gap-2">
          <Mail className="w-4 h-4 text-foreground/60 shrink-0" />
          <span className="text-sm font-medium text-foreground">contato@bwild.com.br</span>
        </div>
      </div>

      {/* Signature */}
      <div className="pt-3 border-t border-border">
        <p className="text-sm sm:text-base font-semibold text-foreground">{data.preparedBy}</p>
        <p className="text-xs sm:text-sm text-primary font-medium">Gestão de Obras - Bwild</p>
      </div>
    </div>
  );
};
