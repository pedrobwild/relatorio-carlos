...
export const journeyCopy = {
  ...
  stageSummary: {
    ...
    all_good: {
      ...
      subtitle: 'Nossa equipe está conduzindo esta etapa. Você verá por aqui se algo precisar de você.',
    },
    in_review: {
      title: 'Em validação',
  ...
  dates: {
    ...
    meeting: {
      ...
      customerMicrocopy: 'Sua sugestão será analisada pela equipe Bwild. Entraremos em contato para confirmar a melhor data.',
    },
    form: {
    ...
    history: {
      ...
      emptySubtitle: 'O histórico aparecerá aqui conforme as datas forem atualizadas.',
      actions: {
