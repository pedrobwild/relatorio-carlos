...
import type { DocumentCategory, DocumentStatus, DocumentWithUrl } from '@/infra/repositories/documents.repository';
import { useAuth } from './useAuth';
import { toast } from 'sonner';

// Re-export types and constants for convenience
export { DOCUMENT_CATEGORIES } from '@/infra/repositories/documents.repository';
export type { DocumentCategory, DocumentStatus, DocumentWithUrl } from '@/infra/repositories/documents.repository';
...
export function useDocumentsByCategoryQuery(
  ...
  const categoryDocs = documentsQuery.data?.filter(
