...
const FornecedorDetalhe = lazy(
  () => import("./pages/gestao/FornecedorDetalhe"),
);
const FornecedoresAdmin = lazy(
  () => import("./pages/gestao/FornecedoresAdmin"),
);
...
const NaoConformidadesGlobal = lazy(
  () => import("./pages/gestao/NaoConformidadesGlobal"),
);
  ...
  if (persister) {
    return (
      <PersistQueryClientProvider
        ...
        onError={() => {
          console.warn(
            "[QueryPersist] Failed to restore cache, starting fresh",
          );
          ...
          <TooltipProvider>
            ...
            <Routes>
              ...
              <Route
                ...
                element={withSuspense(<RedefinirSenha />)}
              />
              <Route
                path="/verificar/:hash"
              ...
              <Route
                path="/gestao"
                element={<Navigate to="/gestao/painel-obras" replace />}
              />
              <Route
              ...
              <Route
                ...
                element={<Navigate to="/gestao/estoque?tab=saidas" replace />}
              />
              <Route
              ...
              <Route
                ...
                element={
                  <StaffRoute>
                    <AppShell variant="portfolio">
                      {withSuspense(<RelatoriosInternos />)}
                    </AppShell>
                  </StaffRoute>
                }
              />
              ...
              />
              <Route
                path="/gestao/diario/:projectId/:date"
                element={
                  <StaffRoute>
                    <AppShell variant="portfolio">
                      {withSuspense(<DiarioDia />)}
                    </AppShell>
                  </StaffRoute>
                }
              />
              ...
              <Route
                path="/gestao/cs"
                element={<Navigate to="/gestao/cs/operacional" replace />}
              />
              <Route
              ...
              <Route
                path="/arquivos"
                element={
                  <ProtectedRoute>{withSuspense(<Arquivos />)}</ProtectedRoute>
                }
              />
              ...
              <Route
                path="/admin"
                element={<AdminRoute>{withSuspense(<Admin />)}</AdminRoute>}
              />
              <Route
                path="/admin/auditoria"
                element={
                  <AdminRoute>{withSuspense(<AdminAuditoria />)}</AdminRoute>
                }
              />
              <Route
                path="/admin/health"
                element={
                  <AdminRoute>{withSuspense(<AdminHealth />)}</AdminRoute>
                }
              />
              <Route
                path="/admin/ux-insights"
                element={
                  <AdminRoute>{withSuspense(<AdminUxInsights />)}</AdminRoute>
                }
              />
              <Route
                path="/admin/research"
                element={
                  <AdminRoute>{withSuspense(<AdminResearch />)}</AdminRoute>
                }
              />
              <Route
                path="/demo"
                element={<AdminRoute>{withSuspense(<Demo />)}</AdminRoute>}
              />
              ...
              <Route
                path="/minhas-obras"
                element={
                  <CustomerRoute>{withSuspense(<MinhasObras />)}</CustomerRoute>
                }
              />
              ...
              <Route
                ...
                element={
                  <ProtectedRoute>
                    <ProjectPage>
                      {withSuspense(<FormalizacaoDetalhe />)}
                    </ProjectPage>
                  </ProtectedRoute>
                }
              />
              ...
              <Route
                path="/relatorio"
                element={<Navigate to="/minhas-obras" replace />}
              />
              <Route
                path="/contrato"
                element={<Navigate to="/minhas-obras" replace />}
              ...
              />
              <Route
                path="/formalizacoes/nova"
                element={<Navigate to="/minhas-obras" replace />}
              />
              <Route
                path="/formalizacoes/:id"
                element={<Navigate to="/minhas-obras" replace />}
              />
