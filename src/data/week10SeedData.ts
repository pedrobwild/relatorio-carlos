  ...
  risksAndIssues: [
    {
      ...
      severity: "média",
      actionPlan: "1) Contato direto com gerente Fast Cargo (Carlos - 11 98765-4321) para priorização; 2) Plano B: entrega parcial e instalação posterior; 3) Reservar janela de elevador para 10/09 como contingência",
    ...
    },
    {
      ...
      severity: "média",
      actionPlan: "1) Marceneiro Antônio realizará troca da porta (peça reserva em estoque); 2) Reinstalação das dobradiças Blum; 3) Nova inspeção de alinhamento pós-troca",
    ...
    },
    {
      ...
      severity: "alta",
      actionPlan: "1) Reserva já solicitada para 09/09 das 8h às 12h (protocolo #2847); 2) Confirmação com portaria Sr. José; 3) Backup: reserva secundária para 10/09 caso haja atraso de entrega",
