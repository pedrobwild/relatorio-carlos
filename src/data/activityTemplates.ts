...
export const activityTemplateSets: ActivityTemplateSet[] = [
  {
    ...
    name: 'Reforma Studio',
    emoji: '🏠',
    description: 'Template padrão para reforma de studios e apartamentos compactos (45-60 dias).',
    activities: [
  ...
  },
  {
    ...
    emoji: '📐',
    description: 'Template para fase de projeto (3D + Executivo + Aprovações, 30-45 dias).',
    activities: [
      { description: 'Briefing e levantamento', durationDays: 3, weight: 8 },
      { description: 'Estudo preliminar (layout)', durationDays: 5, weight: 10 },
      ...
      { description: 'Projeto Executivo – Plantas', durationDays: 7, weight: 15 },
      { description: 'Projeto Executivo – Detalhamentos', durationDays: 5, weight: 10 },
      { description: 'Revisão e ajustes', durationDays: 3, weight: 5 },
      { description: 'Aprovação e assinatura do Executivo', durationDays: 3, weight: 7 },
  ...
  },
  {
    ...
    emoji: '🔨',
    description: 'Template para reformas maiores com todas as etapas (90-120 dias).',
    activities: [
      { description: 'Mobilização e proteção de áreas comuns', durationDays: 3, weight: 2 },
      { description: 'Demolição geral', durationDays: 7, weight: 4 },
      { description: 'Remoção de entulho', durationDays: 3, weight: 2 },
      { description: 'Instalações elétricas – infraestrutura', durationDays: 10, weight: 7 },
      { description: 'Instalações hidráulicas – água fria e quente', durationDays: 8, weight: 6 },
      { description: 'Instalações de gás', durationDays: 3, weight: 3 },
      { description: 'Ar-condicionado – infraestrutura', durationDays: 5, weight: 4 },
      { description: 'Alvenaria e divisórias', durationDays: 7, weight: 5 },
      { description: 'Impermeabilização de áreas molhadas', durationDays: 5, weight: 4 },
      { description: 'Contrapiso e regularização', durationDays: 5, weight: 4 },
      { description: 'Revestimento cerâmico – piso', durationDays: 8, weight: 6 },
      { description: 'Revestimento cerâmico – parede', durationDays: 7, weight: 5 },
      { description: 'Forro de gesso e iluminação', durationDays: 7, weight: 5 },
      { description: 'Instalações elétricas – acabamento', durationDays: 5, weight: 4 },
      { description: 'Pintura – massa e lixamento', durationDays: 5, weight: 4 },
      { description: 'Pintura – acabamento', durationDays: 5, weight: 4 },
      { description: 'Portas e ferragens', durationDays: 4, weight: 3 },
      { description: 'Louças, metais e acessórios', durationDays: 4, weight: 4 },
      { description: 'Marcenaria – instalação', durationDays: 7, weight: 8 },
      { description: 'Vidraçaria e espelhos', durationDays: 3, weight: 3 },
      { description: 'Ar-condicionado – instalação', durationDays: 3, weight: 3 },
...
): { id: string; description: string; plannedStart: string; plannedEnd: string; actualStart: string; actualEnd: string; weight: string; predecessorIds: string[] }[] {
