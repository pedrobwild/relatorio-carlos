  ...
  const renderBody = () => {
    ...
    if (done) {
      return (
        <div className="flex flex-col items-center gap-3 py-4 text-center">
          ...
          <p className="text-sm text-white/80">Senha alterada com sucesso. Redirecionando...</p>
        </div>
      );
    }
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <Label htmlFor="confirm" className="text-white/90">Confirmar nova senha</Label>
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-white/50" />
            <Input
              id="confirm"
          ...
          {fieldErrors.confirm && (
            <p id="confirm-error" role="alert" className="text-xs text-red-400 mt-1">
              {fieldErrors.confirm}
            </p>
          )}
        </div>
        ...
        {formError && (
          <p role="alert" className="text-sm text-red-400 flex items-start gap-2">
