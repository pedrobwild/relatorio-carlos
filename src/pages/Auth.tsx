    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes("Invalid login credentials")) {
          ...
          setFormError(
            "Seu acesso ainda não foi ativado. Fale com o suporte para liberar.",
          );
        } else if (/inactive|blocked|disabled/i.test(error.message)) {
          setFormError(
            "Seu acesso está inativo. Fale com o suporte para liberar.",
          );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-stretch w-full md:max-w-lg px-5 sm:px-12 md:px-16 py-10 sm:py-16 safe-area-top safe-area-bottom mx-auto md:mx-0">
        <div className="w-full max-w-[220px] sm:max-w-[280px] md:max-w-[340px] lg:max-w-[380px] mx-auto md:mx-0 mb-8 sm:mb-10 self-center md:self-start">
          <img
            src={workflowLogo}
          ...
          >
            ...
            <div className="text-sm text-emerald-100">
              ...
              <p className="text-xs text-emerald-200/80 mt-0.5">
                Basta clicar em <strong>Entrar</strong> para visualizar o
                orçamento na obra demo.
              </p>
            </div>
          </div>
        )}
