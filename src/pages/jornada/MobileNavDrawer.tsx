import { Menu, Map, DollarSign, FolderOpen, ClipboardSignature, AlertCircle } from 'lucide-react';
...
const navItems = [
  ...
  { key: 'formalizacoes', label: journeyCopy.tabs.formalizacoes, icon: ClipboardSignature },
...
export function MobileNavDrawer({ activeTab, onTabChange, pendingCount }: MobileNavDrawerProps) {
