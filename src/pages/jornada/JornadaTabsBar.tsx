import { Map, DollarSign, FolderOpen, ClipboardSignature, AlertCircle } from 'lucide-react';
...
export function JornadaTabsBar({ activeTab, onTabChange, projectId, pendingCount }: JornadaTabsBarProps) {
  return (
