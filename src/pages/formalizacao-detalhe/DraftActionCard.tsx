...
export function DraftActionCard({ hasParties, sendingForSignature, onSendForSignature }: DraftActionCardProps) {
  return (
      ...
      <CardContent className="p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 space-y-4">
            <div>
              <h3 className="font-medium text-blue-900 dark:text-blue-100">Rascunho</h3>
            ...
            <div className="flex gap-3">
              ...
              >
                {sendingForSignature ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Send className="h-4 w-4 mr-2" />}
