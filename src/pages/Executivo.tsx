      ...
      <div className="sticky top-0 z-50 bg-gradient-to-r from-primary/5 via-background to-background border-b border-border px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold text-lg text-foreground">Projeto Executivo</h1>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-xl border border-border p-6 md:p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>Esta página conterá os documentos técnicos do projeto executivo, incluindo:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Plantas baixas detalhadas</li>
                <li>Projeto elétrico e hidráulico</li>
                <li>Detalhamentos de marcenaria</li>
