...
export default function ComprasPrestadores() {
  const state = useComprasState('prestador');
  ...
  const availableSubcategories = getSubcategoriesByType('prestadores');
    ...
    <div className="min-h-screen bg-background">
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: "Compras", href: `/obra/${state.projectId}/compras` },
          { label: "Prestadores" },
        ]}
      >
        ...
        <PageContainer maxWidth="full" className="space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[200px] max-w-sm">
              ...
              <Input
                placeholder="Buscar prestador, categoria..."
                className="pl-9 h-9"
                value={searchQuery}
            ...
            <Select value={state.filterStatus} onValueChange={state.setFilterStatus}>
              ...
              <SelectContent>
                ...
                <SelectItem value="ordered">Contratado</SelectItem>
                <SelectItem value="in_transit">Em Execução</SelectItem>
