import { ArrowLeft, Download, Box, ExternalLink, FileText } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="flex items-center gap-2">
                <Box className="w-5 h-5 text-primary hidden sm:block" />
                <h1 className="font-bold text-base sm:text-lg text-foreground">Projeto 3D</h1>
              </div>
            </div>
          </div>
          {hasDocument && (
