    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-4 py-4 sm:py-6 pb-[88px] sm:pb-6">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 rounded-xl border border-amber-500/20 bg-amber-50 dark:bg-amber-500/5 p-3 mb-4"
        >
          <Rocket className="h-4 w-4 text-amber-600 shrink-0" />
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-amber-800 dark:text-amber-400">Rascunho — Recebido via integração</p>
