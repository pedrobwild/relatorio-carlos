...
export function TabPagamentos({
  ...
  const openMethodModal = (p: Payment) =>
    setMethodModal({ open: true, payment: p });
    ...
    <div className="space-y-6">
                ...
                <label className="flex items-center gap-2 text-xs text-muted-foreground cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setNewPayment({
                        ...newPayment,
                        dueDatePending: e.target.checked,
                        due_date: "",
                      })
                    }
                    className="rounded"
                      ...
                      <TableRow key={p.id}>
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            <Input
                              ...
                              className="h-8 w-36"
                              disabled={!p.due_date && p.due_date !== ""}
                            />
                            <label className="flex items-center gap-1.5 text-xs text-muted-foreground cursor-pointer whitespace-nowrap">
                              <input
                                type="checkbox"
                                checked={p.due_date === null}
                                onChange={(e) => {
                                  onUpdate(
                                    p.id,
                                    "due_date",
                        ...
                        <TableCell>
                          <Button
                            ...
                            className={`whitespace-nowrap ${p.paid_at ? "bg-emerald-600 hover:bg-emerald-700" : ""}`}
                          >
      ...
      {methodModal.payment && (
        <PaymentMethodModal
          ...
          initialMethod={
            (methodModal.payment.payment_method || "") as
              | "pix"
              | "boleto"
              | "cartao"
              | "transferencia"
