        ...
        >
          <div className="flex items-center gap-3">
              ...
              {Array.from({ length: totalSteps }).map((_, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    i === currentStep ? 'bg-primary/50 animate-pulse' :
            ...
            <span className="text-xs font-medium text-muted-foreground">
              {completedCount}/{totalSteps} · <span className="text-foreground">{currentLabel}</span>
            </span>
          </div>
            ...
            {stepLabels.map((label, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={cn('font-medium', isCurrent ? 'text-primary' : 'text-muted-foreground')}>
                    {label}
                  </span>
