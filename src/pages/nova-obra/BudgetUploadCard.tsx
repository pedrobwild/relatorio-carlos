...
import { FileSpreadsheet, Upload, X, FileText, CheckCircle2 } from 'lucide-react';
...
export function BudgetUploadCard({ file, onFileChange, formData, onChange }: BudgetUploadCardProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Opcional — Anexe o orçamento detalhado (PDF, Excel ou CSV) para referência comercial e geração futura de cronograma.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <input
        ...
        {!file ? (
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border border-primary/20 bg-primary/5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground">{formatFileSize(file.size)} · Pronto para envio</p>
            </div>
            <Button
              type="button"
              variant="ghost"
