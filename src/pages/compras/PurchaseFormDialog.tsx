      ...
      <DialogContent className="max-w-2xl max-h-[95dvh] overflow-y-auto">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            {isPrestador && (
              <>
                <FornecedorSelector
                  ...
                  startDate={
                    formData.start_date || formData.required_by_date || ""
                  }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    actual_cost: parseFloat(e.target.value) || undefined,
                  }))
                }
                placeholder="0,00"
              />
            ...
            {(formData.estimated_cost || 0) > 0 &&
              (formData.actual_cost || 0) > 0 &&
              (() => {
