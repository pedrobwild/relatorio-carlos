...
export const partyTypeSchema = z.enum(['customer', 'contractor', 'witness', 'manager']);
...
export type CreateFormalizationInput = z.infer<typeof createFormalizationSchema>;
...
export const pendingItemStatusSchema = z.enum(['pending', 'completed', 'cancelled']);
